        ...
        <div className="flex items-center gap-2">
          {visibleAlerts.length > 0 && !collapsed && (
            <button
              ...
              className="text-[11px] text-slate-400 hover:text-slate-100 px-2.5 py-1 rounded-lg bg-slate-800 hover:bg-slate-700 transition-colors cursor-pointer border border-slate-700"
            >
              Đóng tất cả
            </button>
          )}
          {collapsed
            ? <ChevronDown className="w-4 h-4 text-slate-400 group-hover:text-slate-100 transition-colors" />
              ...
              return (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="text-xs font-bold text-slate-100 leading-snug">{alert.title}</p>
                  ...
                  <button
                    ...
                    className="shrink-0 p-1 rounded-lg text-slate-500 hover:text-slate-100 hover:bg-slate-700 transition-colors cursor-pointer"
