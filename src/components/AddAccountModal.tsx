...
export default function AddAccountModal({ onSuccess }: AddAccountModalProps) {
  ...
  return (
    <>
      <button
        ...
        className="px-4 py-2.5 rounded-xl bg-gradient-to-r from-emerald-500 to-teal-400 hover:from-emerald-400 hover:to-teal-300 text-slate-950 font-bold text-sm shadow-lg shadow-emerald-500/20 transition-all flex items-center gap-2 cursor-pointer"
      >
        <Plus className="w-4 h-4" />
        <span>Thêm Tài Sản / Khoản Nợ</span>
      </button>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                <label className="block text-xs font-semibold text-slate-300 mb-1">
                  Tên Tài Khoản / Tài Sản <span className="text-emerald-400">*</span>
                </label>
                <input
                  type="text"
                  required
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <label className="block text-xs font-semibold text-slate-300 mb-1">
                    Loại Tài Sản <span className="text-emerald-400">*</span>
                  </label>
                  <select
                    value={type}
              ...
              <div className="pt-4 flex justify-end gap-3 border-t border-slate-800">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="px-5 py-2.5 rounded-xl bg-emerald-500 hover:bg-emerald-400 text-slate-950 text-sm font-bold shadow-lg shadow-emerald-500/20 transition-all flex items-center gap-2 disabled:opacity-50"
                >
